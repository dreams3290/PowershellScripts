...
$list = "C:\Scripts\DiskSpaceCheckList.txt" 
...
if ($regex.IsMatch($regexsubject)) {
                        sendemail -smtpfrom "diskspacemonitoringalert@test.com" -smtpTo "to@test.com"  -EmailSubject "Disk Space Monitoring Alert" -IsBodyHTMLOK $true -mailBody $HTMLmessage
